...
using UnityEngine.Purchasing;
    ...
    public class IAPManager : MonoBehaviour, IStoreListener
    {
        ...
        public static string PRODUCT_20000_GOLD = "20000gold";
    ...
    private void Start()
        ...
        public void Buy20000Gold()
        {
            // Buy the consumable product using its general identifier. Expect a response either 
            // through ProcessPurchase or OnPurchaseFailed asynchronously.
            BuyProductID(PRODUCT_20000_GOLD);
        }
        ...
        {
            // 10000 gold has been purchased by this user.
            if (String.Equals(args.purchasedProduct.definition.id, PRODUCT_10000_GOLD, StringComparison.Ordinal))
            {
            ...
            {
                PlayerPrefs.SetInt("Gold", PlayerPrefs.GetInt("Gold") + 20000);
                PlayerPrefs.Save();
            }
